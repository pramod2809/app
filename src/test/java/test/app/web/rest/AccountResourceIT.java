package test.app.web.rest;

import test.app.JhipsterappApp;
import test.app.config.Constants;
import test.app.domain.Authority;
import test.app.domain.User;
import test.app.repository.AuthorityRepository;
import test.app.repository.UserRepository;
import test.app.security.AuthoritiesConstants;
import test.app.service.UserService;
import test.app.service.dto.PasswordChangeDTO;
import test.app.service.dto.UserDTO;
import test.app.web.rest.vm.KeyAndPasswordVM;
import test.app.web.rest.vm.ManagedUserVM;
...
import static test.app.web.rest.AccountResourceIT.TEST_USER_LOGIN;
